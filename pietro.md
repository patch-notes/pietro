...
> **Checkpoint 2026-05-14:** plan locked, M1–M6 shipped (backend complete,
> 55/55 Rust tests; UI complete, 243 KB JS / 77 KB gzipped). M7 (embed +
> release) remains. For a one-page resumption snapshot, read **`STATUS.md`**
> at the repo root. For the live milestone state with shipped notes, see
> [§19](#19-milestones-build-order).
